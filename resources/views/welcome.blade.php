    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="{{  asset ('styleTestAdmin/assets/images/logo.svg') }}" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{  asset ('styleTestAdmin/assets/images/logo-mini.svg') }}" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="nav-profile-image">
                  <img src="{{  asset ('styleTestAdmin/assets/images/faces/face1.jpg') }}" alt="profile">
                        ...
                        <div class="card-body">
                            ...
                            <div style="float:left;">
                                ...
                                <div style="float:right;">
                                    <div>
                                        <select name="" onchange="showSelect2(event)" id="selectNum1" class="form-control-lg form-control-sm ">
                                    ...
                                    <div>
                                        <input type="number"  id="Input1NoDisabled" class="form-control-lg form-control-sm ">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="float:right;">
                                ...
                                <div style="float:left;">
                                    <div>
                                        <select id="selectNum2"  onchange="changeHandler2()" class="form-control-lg form-control-sm ">
                                    ...
                                    <div>
                                        <input type="text" id="Input2Disabled" class="form-control-lg form-control-sm " disabled >
                                    </div>
                                </div>
                            ...
                            <button class="btn btn-gradient-danger btn-icon-text" type="submit" > <i class="mdi mdi-upload btn-icon-prepend" ></i> exchange</button>
                          </div>
                        </div>
...
changeHandler(e);  
                     ...
                     dt.forEach(myFunction);
                           ...
                           function myFunction(value) {
                            ...
                            if (  value['name'] === elementSelectedIn1  ) {
                               ...
                               console.log( vlv1['value']);
                               console.log( vlv2['value']);
  ...
  input2.value  = (( input1.value  * vlv1['value']) / vlv2['value']).toFixed(2) ;
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="{{  asset ('styleTestAdmin/assets/images/faces/face1.jpg') }}" class="mr-2" alt="image"> David Grey </td>
                          ...
                          <tr>
                            <td>
                              <img src="{{  asset ('styleTestAdmin/assets/images/faces/face2.jpg') }}" class="mr-2" alt="image"> Stella Johnson </td>
                          ...
                          <tr>
                            <td>
                              <img src="{{  asset ('styleTestAdmin/assets/images/faces/face3.jpg') }}" class="mr-2" alt="image"> Marina Michel </td>
                          ...
                          <tr>
                            <td>
                              <img src="{{  asset ('styleTestAdmin/assets/images/faces/face4.jpg') }}" class="mr-2" alt="image"> John Doe </td>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mt-3">
                      <div class="col-6 pr-1">
                        <img src="{{  asset ('styleTestAdmin/assets/images/dashboard/img_1.jpg')}}" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="{{  asset ('styleTestAdmin/assets/images/dashboard/img_4.jpg')}}" class="mw-100 w-100 rounded" alt="image">
                      </div>
                      <div class="col-6 pl-1">
                        <img src="{{  asset ('styleTestAdmin/assets/images/dashboard/img_2.jpg')}}" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="{{  asset ('styleTestAdmin/assets/images/dashboard/img_3.jpg')}}" class="mw-100 w-100 rounded" alt="image">
                      </div>
                    </div>
                    <div class="d-flex mt-5 align-items-top">
                      <img src="{{  asset ('styleTestAdmin/assets/images/faces/face3.jpg')}}" class="img-sm rounded-circle mr-3" alt="image">
    ...
    <script src="{{  asset ('styleTestAdmin/assets/vendors/chart.js/Chart.min.js') }}"></script>
    ...
    <script src="{{  asset ('styleTestAdmin/assets/js/dashboard.js') }}"></script>
    <script src="{{  asset ('styleTestAdmin/assets/js/todolist.js') }}"></script>
