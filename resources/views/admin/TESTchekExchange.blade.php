  ...
  <body>
    <div class="container-scroller">
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">{{ $exchange->user->name }}</h4>
      ...
      <div style="align:left;"  >
                              ...
                              <div class="form-group row">
                                  <label for="fromValue" class="col-md-4 col-form-label text-md-right">fromValue</label>
                              ...
                              <div class="form-group row">
                                <label for="fromAccount" class="col-md-4 col-form-label text-md-right">fromAccount </label>
                        ...
                        <div style="align:right;"  >
                            ...
                            <div class="form-group row">
                                <label for="toValue" class="col-md-4 col-form-label text-md-right">toValue </label>
                            ...
                            <div class="form-group row">
                                <label for="toAccount" class="col-md-4 col-form-label text-md-right">toAccount </label>
