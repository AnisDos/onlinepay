...
<html lang="en">
  <head>
    ...
    <!-- Datatables -->
    <link href="{{  asset ('styleTestAdmin/vendors/datatables.net-bs/css/dataTables.bootstrap.min.css') }}" rel="stylesheet">
  ...
  <body>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">bank stat</h4>
                    ...
                    <div class="card-body">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-md-6">
                                  <input id="name" type="text" class="form-control" value="{{ $bank->name }}" readonly  >
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-md-6">
                                      <input id="value" type="text" class="form-control"  value="{{ $bank->value }}" readonly >
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="credit" type="text" class="form-control"   value="{{ $bank->credit }}" readonly  >
                            ...
                            <div class="form-group row">
                                <label for="minToCommand" class="col-md-4 col-form-label text-md-right">minToCommand </label>
    
                                <div class="col-md-6">
                                    <input id="minToCommand" type="text" class="form-control"   value="{{ $bank->minToCommand }}" readonly  >
    
                                </div>
                            </div>
      
                            <div class="form-group row">
                                <label for="minCriditInSolde" class="col-md-4 col-form-label text-md-right">minCriditInSolde </label>
    
                                <div class="col-md-6">
                                    <input id="minCriditInSolde" type="text" class="form-control"   value="{{ $bank->minCriditInSolde }}" readonly  >
                            ...
                            <div class="form-group row">
                                <label for="confirmed" class="col-md-4 col-form-label text-md-right">confirmed </label>
                            ...
                            <form id="form_validate_data" method="POST"  action="{{ url('admin/validateExchange') }}">
                                ...
                                <input type="hidden" name="id_exchange"  value="{{ $bank->id }}"   >
    
      
                              <div class="form-group row mb-0">
                                  <div class="col-md-6 offset-md-4">
                                      <button  type="submit"  class="btn btn-inverse-success btn-fw" onclick="samir();" >
                                         valider
                                      </button>
                                  </div>
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="col-lg-12 grid-margin stretch-card" style="margin-top:50px;">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title">exchanges to</h4>
                        <div class="table-responsive">
                          ...
                          @foreach ($exchangesTo as $exchange)
                              ...
                              <tr>
                                <td>
                                  <img src="/storage/{{$exchange->user->image}}" class="mr-2" alt="image">{{ $exchange->user->firstName }} 
                                </td>
                  ...
                  <div class="col-lg-12 grid-margin stretch-card" style="margin-top:50px;">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title">exchanges From</h4>
                        <div class="table-responsive">
                          <table class="table">
                            <thead>
                              <tr>
    ...
    <!-- jQuery -->
    <script src="{{  asset ('styleTestAdmin/vendors/jquery/dist/jquery.min.js') }}"></script>
    <!-- Bootstrap -->
    <script src="{{  asset ('styleTestAdmin/vendors/bootstrap/dist/js/bootstrap.min.js') }}"></script>

      <!-- Datatables -->
    <script src="{{  asset ('styleTestAdmin/vendors/datatables.net/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{  asset ('styleTestAdmin/vendors/datatables.net-bs/js/dataTables.bootstrap.min.js') }}"></script>

    <!-- Custom Theme Scripts -->
    <script src="{{  asset ('styleTestAdmin/vendors/js/custom.min.js') }}"></script>
