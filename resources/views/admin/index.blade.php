        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item"> <a class="nav-link" href="/admin/bank/{{$bank->id}}" >{{$bank->name}}</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('admin/chartBank') }}">
...
@endforeach
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">les exchange confirme</h4>
                    <p class="card-description"> Add class <code>.table-striped</code>
                    </p>
                    <table class="table table-striped">
                      <thead>
                      ...
                      <tbody>
                        @foreach ($exchangesConfiemed as $exchange)
                          ...
                          <td>
                            ...
                            <form id="form_validate_data_26" method="POST"  action="{{ url('user/deleteComment') }}">
                              ...
                              <div class="form-group row mb-0">
                                      ...
                                      <button type="submit" class="btn btn-inverse-danger btn-fw"  onclick="deletComment();">
                                         supprimer
                                      </button>
